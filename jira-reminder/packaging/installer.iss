...
AppPublisher=Jira Work Reminder
DefaultDirName={localappdata}\Programs\JiraWorkReminder
DefaultGroupName=Jira 工作提醒
PrivilegesRequired=lowest
ArchitecturesAllowed=x64compatible
ArchitecturesInstallIn64BitMode=x64compatible
MinVersion=10.0.19041
OutputDir=..\dist
OutputBaseFilename=JiraWorkReminder-{#AppVersion}-Setup-x64
SetupIconFile=..\desktop\bin\WorkReminder.ico
UninstallDisplayIcon={app}\desktop\bin\JiraReminder.exe
...
[Icons]
Name: "{autoprograms}\Jira 工作提醒"; Filename: "{app}\desktop\bin\JiraReminder.exe"; WorkingDir: "{app}"
Name: "{autodesktop}\Jira 工作提醒"; Filename: "{app}\desktop\bin\JiraReminder.exe"; WorkingDir: "{app}"; Tasks: desktopicon
...
Filename: "{app}\desktop\bin\JiraReminder.exe"; Description: "打开 Jira 工作提醒"; Flags: nowait postinstall skipifsilent
