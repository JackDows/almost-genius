...
export function stripPrivateContent(input        )         {
...
export function ingestCaptureEnvelope   (input                 , consumer                                  )    {
...
export function isEnvelopeValidAt(envelope                 , at       = new Date())          {
...
export function filterValidEnvelopes                           (envelopes              , at       = new Date())      {
